...
| `options.byPass` | Bypass options | - |
| `options.byPass.interceptors` | Bypass interceptors options | - |
| `options.byPass.interceptors.pre` | Bypass pre-interceptors | `false` |
| `options.byPass.interceptors.post` | Bypass post-interceptors | `false` |
| `options.byPass.interceptors.error` | Bypass error-interceptors | `false` |
